// Proc_RateCtrlV1.cpp: implementation of the Proc_RateCtrlV1 Parsing
//   Processor class.
//
//////////////////////////////////////////////////////////////////////
...
Proc_RateCtrlV1::Proc_RateCtrlV1()
{
   PcktID = "RateCtrl";
}
...
void Proc_RateCtrlV1::ProcPckt(ParseValue *pPV)
{
   ...
   if(pPV != NULL)
   {
      try
      {
         Om_RateCtrl.SetArtPartID(pPV->GetChar(),true);
