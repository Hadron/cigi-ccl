...
public:
   ...
   //=========================================================
   //! Sets the WindDir with bound checking control
   //! \param BaseEnvCtrlIn - Pointer to the base Environment Control object.
   //!
   //! \return This returns CIGI_SUCCESS or an error code
   //!   defined in CigiErrorCodes.h
   void SetBaseEnvCtrl(CigiBaseEnvCtrl *BaseEnvCtrlIn)
   {
      PEnv = BaseEnvCtrlIn;
   }
...
protected:
   ...
   //=========================================================
   //! BaseEnvCtrl<br>
   //! A pointer to the current Base Environment Control object.
   //!
