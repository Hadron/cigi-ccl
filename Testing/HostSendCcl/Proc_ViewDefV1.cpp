// Proc_ViewDefV1.cpp: implementation of the Proc_ViewDefV1 Parsing
//   Processor class.
//
//////////////////////////////////////////////////////////////////////
...
void Proc_ViewDefV1::ProcPckt(ParseValue *pPV)
{
   ...
   if(pPV != NULL)
   {
      try
      {
         Om_ViewDef.SetViewID(pPV->GetUChar(),true);
         printf("\tView ID = %d\n",pPV->GetUChar());
      }
   ...
   if(pPV != NULL)
   {
      try
      {
         Om_ViewDef.SetTrackerAssigned(pPV->GetBool(),true);
